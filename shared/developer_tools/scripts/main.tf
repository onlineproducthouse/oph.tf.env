...
locals {
  scripts = [
    ...
    { name = "deploy_api_container", key = "/oph/scripts/deploy-api-container.sh", source_path = "./scripts/deploy-api-container.sh" },
    { name = "deploy_batch_container", key = "/oph/scripts/deploy-batch-container.sh", source_path = "./scripts/deploy-batch-container.sh" },

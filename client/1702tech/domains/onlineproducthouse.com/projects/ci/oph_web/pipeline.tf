  ...
  dynamic "stage" {
    ...
    content {
      ...
      action {
        ...
        configuration = {
          ProjectName = module.ci.release_job["sb-qa"].name
        }
      }
    }
  }
  ...
  dynamic "stage" {
    ...
    content {
      ...
      action {
        ...
        configuration = {
          ProjectName = module.ci.release_job["www-qa"].name
        }
      }
    }
  }
  ...
  dynamic "stage" {
    ...
    content {
      ...
      action {
        ...
        configuration = {
          ProjectName = module.ci.release_job["portal-qa"].name
        }
      }
    }
  }
  ...
  dynamic "stage" {
    ...
    content {
      ...
      action {
        ...
        configuration = {
          ProjectName = module.ci.release_job["reg-qa"].name
        }
      }
    }
  }

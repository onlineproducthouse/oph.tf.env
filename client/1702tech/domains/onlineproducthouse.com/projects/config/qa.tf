...
locals {
  ...
  qa = [
    ...
    { id = "qa_db_username", path = local.paths.qa, key = "DB_SUPER_USERNAME", value = local.qa_secrets.db.username },
    { id = "qa_db_password", path = local.paths.qa, key = "DB_SUPER_PASSWORD", value = local.qa_secrets.db.password },

      ...
      container = {
        api = {
          qa = [
            ...
            { id = "ci_deploy_cntnr_api_qa_cluster_name", path = local.paths.ci.deploy.container.api.qa, key = "CLUSTER_NAME", value = data.terraform_remote_state.qa_platform.outputs.qa.platform.compute.api.cluster_name },
        ...
        htmltopdf = {
          qa = [
            { id = "ci_deploy_cntnr_htmltopdf_qa_task_fam", path = local.paths.ci.deploy.container.htmltopdf.qa, key = "TASK_FAMILY", value = data.terraform_remote_state.qa_htmltopdf.outputs.qa.htmltopdf.batch.container.task_definition_family },
            { id = "ci_deploy_cntnr_htmltopdf_qa_task_role_arn", path = local.paths.ci.deploy.container.htmltopdf.qa, key = "TASK_ROLE_ARN", value = data.terraform_remote_state.qa_htmltopdf.outputs.qa.htmltopdf.batch.container.task_role_arn },
            { id = "ci_deploy_cntnr_htmltopdf_qa_cntnr_name", path = local.paths.ci.deploy.container.htmltopdf.qa, key = "CONTAINER_NAME", value = data.terraform_remote_state.qa_htmltopdf.outputs.qa.htmltopdf.batch.container.container_name },
            { id = "ci_deploy_cntnr_htmltopdf_qa_cntnr_cpu", path = local.paths.ci.deploy.container.htmltopdf.qa, key = "CONTAINER_CPU", value = data.terraform_remote_state.qa_htmltopdf.outputs.qa.htmltopdf.batch.container.cpu },
            { id = "ci_deploy_cntnr_htmltopdf_qa_cntnr_mem_res", path = local.paths.ci.deploy.container.htmltopdf.qa, key = "CONTAINER_MEMORY_RESERVATION", value = data.terraform_remote_state.qa_htmltopdf.outputs.qa.htmltopdf.batch.container.memory },
            { id = "ci_deploy_cntnr_htmltopdf_qa_cluster_name", path = local.paths.ci.deploy.container.htmltopdf.qa, key = "CLUSTER_NAME", value = data.terraform_remote_state.qa_platform.outputs.qa.platform.compute.htmltopdf.cluster_name },
            { id = "ci_deploy_cntnr_htmltopdf_qa_svc_name", path = local.paths.ci.deploy.container.htmltopdf.qa, key = "SERVICE_NAME", value = data.terraform_remote_state.qa_htmltopdf.outputs.qa.htmltopdf.batch.container.service_name },
            ...
            { id = "ci_deploy_cntnr_htmltopdf_qa_network_mode", path = local.paths.ci.deploy.container.htmltopdf.qa, key = "NETWORK_MODE", value = data.terraform_remote_state.qa_htmltopdf.outputs.qa.htmltopdf.batch.container.network_mode },
          ]

          test = [
            { id = "ci_deploy_cntnr_htmltopdf_test_task_fam", path = local.paths.ci.deploy.container.htmltopdf.test, key = "TASK_FAMILY", value = data.terraform_remote_state.test_htmltopdf.outputs.test.htmltopdf.batch.container.task_definition_family },
            { id = "ci_deploy_cntnr_htmltopdf_test_task_role_arn", path = local.paths.ci.deploy.container.htmltopdf.test, key = "TASK_ROLE_ARN", value = data.terraform_remote_state.test_htmltopdf.outputs.test.htmltopdf.batch.container.task_role_arn },
            { id = "ci_deploy_cntnr_htmltopdf_test_cntnr_name", path = local.paths.ci.deploy.container.htmltopdf.test, key = "CONTAINER_NAME", value = data.terraform_remote_state.test_htmltopdf.outputs.test.htmltopdf.batch.container.container_name },
            { id = "ci_deploy_cntnr_htmltopdf_test_cntnr_cpu", path = local.paths.ci.deploy.container.htmltopdf.test, key = "CONTAINER_CPU", value = data.terraform_remote_state.test_htmltopdf.outputs.test.htmltopdf.batch.container.cpu },
            { id = "ci_deploy_cntnr_htmltopdf_test_cntnr_mem_res", path = local.paths.ci.deploy.container.htmltopdf.test, key = "CONTAINER_MEMORY_RESERVATION", value = data.terraform_remote_state.test_htmltopdf.outputs.test.htmltopdf.batch.container.memory },
            ...
            { id = "ci_deploy_cntnr_htmltopdf_test_svc_name", path = local.paths.ci.deploy.container.htmltopdf.test, key = "SERVICE_NAME", value = data.terraform_remote_state.test_htmltopdf.outputs.test.htmltopdf.batch.container.service_name },
            ...
            { id = "ci_deploy_cntnr_htmltopdf_test_network_mode", path = local.paths.ci.deploy.container.htmltopdf.test, key = "NETWORK_MODE", value = data.terraform_remote_state.test_htmltopdf.outputs.test.htmltopdf.batch.container.network_mode },
          ]
        }
      }
